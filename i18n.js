...
(function () {
  var DICT = {
    ja: {
      ...
      feat_h2: "気に入る8つのこと", feat_sub: "紙とペンから、あなたの手描きが入った一枚へ。",
      fp_h: "SigNote ひろば", fp_p: "みんなが共有した手描き前景を閲覧・ダウンロード。カテゴリや人気順で探して、ワンタップで自分の写真へ。あなたの作品もシェアできます。",
      ...
      f4_h: "プライバシー重視", f4_p: "編集はすべて端末内で完結し、写真は外部に送信されません。広告なし・トラッキングなし。編集にアカウントは不要、ひろばでのシェア時のみログインします。",
      ...
      priv_s2_p: "「SigNote広場」にログインする際、<strong>Sign in with Apple</strong> または <strong>Google</strong> を通じてユーザー識別子とメールアドレスを取得します。パスワードや実名・プロフィールは取得しません。広場で表示される<strong>作者名は自分で決めるニックネーム</strong>（初期値はランダムな仮名）で、Apple／Google の実名は表示されません。用途：投稿・いいねの識別、アカウントの維持。閲覧とダウンロードにログインは不要です。",
      ...
      sup_a7: "いいえ。動画の選択・編集・合成・書き出しはすべて端末内で完結し、動画や作品がサーバーへ送信されることはありません。広告なし・トラッキングなし。編集にアカウントは不要で、「SigNote ひろば」でのシェア時のみログインします。"
    },
    en: {
      ...
      feat_h2: "Eight things you'll love", feat_sub: "From a sheet of paper and a pen to a photo with your own hand-drawn art.",
      fp_h: "SigNote Plaza", fp_p: "Browse and download hand-drawn foregrounds shared by the community — filter by category, sort by popularity, drop any into your photo with a tap, and share your own.",
      ...
      f4_h: "Privacy first", f4_p: "All editing happens on your device; your photos are never uploaded. No ads, no tracking. No account needed to edit — sign in only to share on the Plaza.",
      ...
      priv_s2_p: "When you sign in to SigNote Plaza, we receive a user identifier and your email address via <strong>Sign in with Apple</strong> or <strong>Google</strong>. We never receive your password, real name, or profile. Your <strong>creator name is a nickname you choose</strong> (a random alias by default) — your real Apple/Google name is never displayed. Purpose: identifying your uploads and likes and maintaining your account. Browsing and downloading do not require sign-in.",
      ...
      sup_a7: "No. Picking, editing, compositing, and exporting your videos all happen on your device — nothing is uploaded to any server. No ads, no tracking. No account needed to edit — sign in only to share on SigNote Plaza."
    }
  };
